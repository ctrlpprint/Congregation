...
{
	/// <summary>
	/// Provides a standard base class for facilitating comparison of objects. From SharpLite
	/// 
	...
	/// </summary>
	[Serializable]
	public abstract class ComparableObject : IComparableObject
	{
		/// <summary>
		...
		/// that the ComparableObject already takes care of performance caching, so this method 
